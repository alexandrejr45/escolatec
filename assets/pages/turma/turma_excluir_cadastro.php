            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <div>
                            <h2>Você deseja mesmo excluir o cadastro da turma <?=$nome?> ?</h2>

                            <a href="turmas2.php"> <button class="btn btn-danger">Não</button></a>

                            <form action ='../../../model/turma/turma_excluir.php' method="post">
