                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <form style="margin-top: 30px" action="../../../model/turma/turma_alterar.php" method="post">
                                <label style="font-size: 20px">Nome
                                    <input name="nome" value="<? echo retornaDadosTurma($id, 1)?>" class="form-control" type="text" required>
                                </label>
