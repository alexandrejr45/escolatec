                ...
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            ...
                            <h2 style="margin-bottom: 20px">Responsáveis</h2>
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    <li class="page-item"><a class="page-link" href="alunos_responsaveis.php?pagina=0">Anterior</a></li>
                                    <?php
                                    for($i = 0; $i < $num_paginas; $i++) {
                                        ...
                                        ?>
                                        <li class="page-item <?echo $estilo?>"><a href="alunos_responsaveis.php?pagina=<?echo $i?>"><?echo $i + 1?></a></li>
                                        <?
                                    }
                                    ?>

                                    <li class="page-item"><a class="page-link" href="alunos_responsaveis.php?pagina=<?echo $id_pagina + 1?>">Próxima</a></li>
                                </ul>
                            </nav>
