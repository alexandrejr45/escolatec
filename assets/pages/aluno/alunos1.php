            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        ...
                        <?php
                        if(isset($_SESSION['aluno_deletado'])){
                            ?>

                            <h2 class="alert-success">Aluno excluído com sucesso</h2>

                            <?php
                        }else if(isset($_SESSION['aluno_permanece'])){
                            ?>
                            <h2 class="alert-danger">Falha na exclusão do aluno</h2>

                            <?php
                        }

                        unset($_SESSION['aluno_deletado']);
                        unset($_SESSION['aluno_permanece']);
                        ?>
