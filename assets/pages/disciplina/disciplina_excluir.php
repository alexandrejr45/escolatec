                        ...
                        <div id="page-inner">
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <div>
                                        <h2>Você deseja mesmo excluir o cadastro da disciplina <?=$nome?> ?</h2>

                                        <a href="disciplinas2.php"> <button class="btn btn-danger">Não</button></a>

                                        <form action ='../../../model/disciplina/disciplina_excluir.php' method="post">
